...
namespace MetodaNewtonSisteme
{
    class Program
    {
        ...
        static void Calls(decimal x, decimal y)
        {
            ...
            MetodaNewtonSisteme(1e-12M);
        }

        static void MetodaNewtonSisteme(decimal eps)
        {
            decimal xn_1 = x0, yn_1 = y0;
            decimal j = J(xn_1, yn_1);
        ...
        {
            return xn_1 - 1.0M / j * (F(xn_1, yn_1) * DGy(xn_1, yn_1) - G(xn_1, yn_1) * DFy(xn_1, yn_1));
        }

        static decimal CalculateYN(decimal xn_1, decimal yn_1, decimal j)
        {
            return yn_1 - 1.0M / j * (DFx(xn_1, yn_1) * G(xn_1, yn_1) - DGx(xn_1, yn_1) * F(xn_1, yn_1));
        }
