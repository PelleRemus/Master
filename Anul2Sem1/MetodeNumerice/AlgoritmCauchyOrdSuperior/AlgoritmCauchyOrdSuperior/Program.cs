...
namespace AlgoritmCauchyOrdSuperior
{
    class Program
    {
        //
        // Date de intrare  -------------------------------------------------------------------------------------------
        // a, b, y0, F (epsilon si n vor fi date ca parametru functiei CauchySup)
        //
        ...
        static void Calls(int n, decimal eps)
        {
            CauchySup(n, eps);
        }

        static void CauchySup(int n, decimal eps)
        {
            //
            // Pasul 2 ----------------------------------------------------------------------------------------------------
            // Calculeaza x[0] si h
